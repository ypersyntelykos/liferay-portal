...
/**
 * The utility for the social activity limit local service. This utility wraps {@link com.liferay.portlet.social.service.impl.SocialActivityLimitLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class SocialActivityLimitLocalServiceUtil {
	...
	*/
	public static com.liferay.portlet.social.model.SocialActivityLimit updateSocialActivityLimit(
		...
		boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateSocialActivityLimit(socialActivityLimit, merge);
	}
