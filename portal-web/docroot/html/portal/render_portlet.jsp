...
LiferayPortletURL urlEdit = PortletURLFactoryUtil.create(request, portletDisplay.getId(), themeDisplay, PortletRequest.RENDER_PHASE);
...
LiferayPortletURL urlEditDefaults = PortletURLFactoryUtil.create(request, portletDisplay.getId(), themeDisplay, PortletRequest.RENDER_PHASE);
...
LiferayPortletURL urlEditGuest = PortletURLFactoryUtil.create(request, portletDisplay.getId(), themeDisplay, PortletRequest.RENDER_PHASE);
...
LiferayPortletURL urlExportImport = PortletURLFactoryUtil.create(request, PortletKeys.EXPORT_IMPORT, themeDisplay, PortletRequest.RENDER_PHASE);
...
LiferayPortletURL urlHelp = PortletURLFactoryUtil.create(request, portletDisplay.getId(), themeDisplay, PortletRequest.RENDER_PHASE);
...
PortletURLImpl urlMax = (PortletURLImpl)PortletURLFactoryUtil.create(request, portletDisplay.getId(), themeDisplay, lifecycle);
...
LiferayPortletURL urlPrint = PortletURLFactoryUtil.create(request, portletDisplay.getId(), themeDisplay, PortletRequest.RENDER_PHASE);
...
LiferayPortletURL urlStaging = PortletURLFactoryUtil.create(request, PortletKeys.EXPORT_IMPORT, themeDisplay, PortletRequest.RENDER_PHASE);
