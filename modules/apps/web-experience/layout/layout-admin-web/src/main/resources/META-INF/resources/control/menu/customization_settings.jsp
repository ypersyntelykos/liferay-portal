	...
	<div class="control-menu-level-2">
		<div class="container-fluid-1280">
			...
			<ul class="control-menu-level-2-nav control-menu-nav">
				...
				PortletURL resetCustomizationViewURL = PortletURLFactoryUtil.create(request, LayoutAdminPortletKeys.LAYOUT_ADMIN, themeDisplay, PortletRequest.ACTION_PHASE);
				...
				PortletURL toggleCustomizationViewPortletURL = PortletURLFactoryUtil.create(request, LayoutAdminPortletKeys.LAYOUT_ADMIN, themeDisplay, PortletRequest.ACTION_PHASE);
