...
PortletURL viewPageURL = PortletURLFactoryUtil.create(request, WikiPortletKeys.WIKI, themeDisplay, PortletRequest.ACTION_PHASE);
...
PortletURL editPageURL = PortletURLFactoryUtil.create(request, WikiPortletKeys.WIKI, themeDisplay, PortletRequest.ACTION_PHASE);
