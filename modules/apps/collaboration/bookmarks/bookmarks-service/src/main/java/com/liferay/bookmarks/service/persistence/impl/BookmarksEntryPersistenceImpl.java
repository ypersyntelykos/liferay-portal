...
public class BookmarksEntryPersistenceImpl extends BasePersistenceImpl<BookmarksEntry>
	...
	private static final String _SQL_COUNT_BOOKMARKSENTRY = "SELECT COUNT(*) FROM BookmarksEntry bookmarksEntry";
	private static final String _SQL_COUNT_BOOKMARKSENTRY_WHERE = "SELECT COUNT(*) FROM BookmarksEntry bookmarksEntry WHERE ";
