...
public class NettyFabricAgentStubTest {
	...
	public void testConstructor() {
		try {
			new NettyFabricAgentStub(null, null, null);
		...
		try {
			new NettyFabricAgentStub(_embeddedChannel, null, null);
		...
		try {
			new NettyFabricAgentStub(
				_embeddedChannel, new MockRepository(), null);
	...
	public void testEquals() {
		...
		anotherNettyFabricAgentStub =
			new NettyFabricAgentStub(
				_embeddedChannel, new MockRepository(),
				Paths.get("AnotherRepositoryPath"));
	...
	@Test
	public void testExecuteWithCancellation() throws ProcessException {
