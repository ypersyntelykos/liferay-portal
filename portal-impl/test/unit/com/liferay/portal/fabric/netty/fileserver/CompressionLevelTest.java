...
public class CompressionLevelTest {
	...
	public void testLevels() {
		...
		Assert.assertEquals(2, CompressionLevel.LEVEL2.getLevel());
		Assert.assertEquals(3, CompressionLevel.LEVEL3.getLevel());
		Assert.assertEquals(4, CompressionLevel.LEVEL4.getLevel());
		Assert.assertEquals(5, CompressionLevel.LEVEL5.getLevel());
		Assert.assertEquals(6, CompressionLevel.LEVEL6.getLevel());
		Assert.assertEquals(7, CompressionLevel.LEVEL7.getLevel());
		Assert.assertEquals(8, CompressionLevel.LEVEL8.getLevel());
		Assert.assertEquals(
	...
	public void testLookupTable() {
		...
		try {
			...
			Assert.assertEquals(
				"Unknown compression level 10, acceptable value range is " +
					"[-1, 9]",
				iae.getMessage());
		}
	}
