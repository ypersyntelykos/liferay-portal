...
public class JMXProxyUtilTest {
	...
	@Test
	public void testOperationProcessCallableFail() throws ProcessException {
	...
	protected static void assertEquals(
		...
		for (int i = 0; i < monitorInfos1.length; i++) {
			Assert.assertEquals(
				monitorInfos1[1].getClassName(),
				monitorInfos2[1].getClassName());
			Assert.assertEquals(
				monitorInfos1[1].getIdentityHashCode(),
				monitorInfos2[1].getIdentityHashCode());
			Assert.assertEquals(
				monitorInfos1[1].getLockedStackDepth(),
				monitorInfos2[1].getLockedStackDepth());
			Assert.assertEquals(
				monitorInfos1[1].getLockedStackFrame(),
				monitorInfos2[1].getLockedStackFrame());
		}
	}
