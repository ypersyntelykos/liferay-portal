...
public class ResourceActionsTest {
	...
	public void testModelGetsRemovedWhenRemovingAllReferencedPortlets()
		...
		Assert.assertTrue(portletNames.contains(_PORTLET_NAME));
		...
		ResourceActionsUtil.removePortletResource(_PORTLET_NAME);

		portletNames = ResourceActionsUtil.getPortletNames();

		Assert.assertFalse(portletNames.contains(_PORTLET_NAME));
		Assert.assertTrue(portletNames.contains(_PORTLET_NAME_2));
