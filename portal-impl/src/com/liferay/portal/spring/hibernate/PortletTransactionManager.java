...
public class PortletTransactionManager implements PlatformTransactionManager {
	...
	public void commit(TransactionStatus transactionStatus)
		...
		_portalHibernateTransactionManager.commit(
			_resetSessionHolder(transactionStatus));
	}
	...
	public void rollback(TransactionStatus transactionStatus)
		...
		_portalHibernateTransactionManager.rollback(
			_resetSessionHolder(transactionStatus));
	}
	...
	private TransactionStatus _resetSessionHolder(
		...
		if (transactionStatus instanceof TransactionStatusWrapper) {
			...
			return transactionStatusWrapper.reset();
		}
