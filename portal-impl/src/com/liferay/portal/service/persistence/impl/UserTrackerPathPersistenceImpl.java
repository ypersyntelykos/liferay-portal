...
public class UserTrackerPathPersistenceImpl extends BasePersistenceImpl<UserTrackerPath>
	...
	public UserTrackerPath updateImpl(UserTrackerPath userTrackerPath) {
		...
		if (!UserTrackerPathModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			...
			finderCache.removeResult(FINDER_PATH_COUNT_BY_USERTRACKERID, args);
	...
	private static final String _SQL_COUNT_USERTRACKERPATH = "SELECT COUNT(*) FROM UserTrackerPath userTrackerPath";
	private static final String _SQL_COUNT_USERTRACKERPATH_WHERE = "SELECT COUNT(*) FROM UserTrackerPath userTrackerPath WHERE ";
