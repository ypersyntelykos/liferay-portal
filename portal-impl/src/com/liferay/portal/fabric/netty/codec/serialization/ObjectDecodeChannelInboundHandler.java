...
public abstract class ObjectDecodeChannelInboundHandler<T>
	...
	public void handlerAdded(ChannelHandlerContext channelHandlerContext)
		...
		if (annotatedObjectDecoder != null) {
			_addedField.setBoolean(this, false);

			doAdd(annotatedObjectDecoder);
		}
	}
	...
	protected void doAdd(AnnotatedObjectDecoder annotatedObjectDecoder) {
		annotatedObjectDecoder.addLast(this);
	}

	private static Field _addedField;

	static {
		try {
			_addedField = ReflectionUtil.getDeclaredField(
