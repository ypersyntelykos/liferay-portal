...
public class AnnotatedObjectDecoder extends LengthFieldBasedFrameDecoder {
	...
	public static final String NAME = "ANNOTATED_OBJECT_DECODER";
	...
	public <T extends ObjectDecodeChannelInboundHandler<?>> void remove(
		Class<T> handlerType) {

		_channelPipeline.remove(handlerType);
	}
