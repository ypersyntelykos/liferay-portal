...
import com.liferay.portal.fabric.netty.handlers.NettyFabricWorkerStubExecutionChannelHandler;
...
public class NettyFabricClient implements FabricClient {
	...
	public NettyFabricClient(
		NettyFabricAgentSkeleton nettyFabricAgent,
...
//		serverBootstrap.option(ChannelOption.SO_BACKLOG, -1);
		...
		bootstrap.handler(new ChannelInitializer<SocketChannel>() {
			...
			protected void initChannel(SocketChannel socketChannel) {
				...
				channelPipeline.addLast(
					...
					new NettyFabricWorkerStubExecutionChannelHandler(
						_nettyFabricAgent));
	...
	private final NettyFabricAgentSkeleton _nettyFabricAgent;
