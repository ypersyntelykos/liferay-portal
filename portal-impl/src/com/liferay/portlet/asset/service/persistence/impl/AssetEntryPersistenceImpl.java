...
public class AssetEntryPersistenceImpl extends BasePersistenceImpl<AssetEntry>
	...
	private static final String _SQL_COUNT_ASSETENTRY = "SELECT COUNT(*) FROM AssetEntry assetEntry";
	private static final String _SQL_COUNT_ASSETENTRY_WHERE = "SELECT COUNT(*) FROM AssetEntry assetEntry WHERE ";
