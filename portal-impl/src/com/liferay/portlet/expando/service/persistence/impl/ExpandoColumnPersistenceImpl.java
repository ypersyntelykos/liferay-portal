...
public class ExpandoColumnPersistenceImpl extends BasePersistenceImpl<ExpandoColumn>
	...
	private static final String _SQL_COUNT_EXPANDOCOLUMN = "SELECT COUNT(*) FROM ExpandoColumn expandoColumn";
	private static final String _SQL_COUNT_EXPANDOCOLUMN_WHERE = "SELECT COUNT(*) FROM ExpandoColumn expandoColumn WHERE ";
